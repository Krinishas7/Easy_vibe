...
from events.models import Event, SeatType
...
class Booking(models.Model):
    ...
    seat_type = models.ForeignKey(SeatType, on_delete=models.PROTECT, related_name='bookings')
    ...
    def save(self, *args, **kwargs):
        # Calculate total amount based on seat_type price
        self.total_amount = self.seat_type.price * self.quantity

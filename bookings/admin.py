...
class BookingAdmin(admin.ModelAdmin):
    list_display = [
        'booking_id', 'user', 'event', 'seat_type', 'quantity', 'total_amount', 
        'status', 'created_at', 'payment_status'
    ]
    list_filter = ['status', 'created_at', 'event__category', 'seat_type']
    search_fields = [
    ...
    fieldsets = (
        ('Booking Information', {
            'fields': ('booking_id', 'user', 'event', 'seat_type', 'quantity', 'total_amount', 'status')
        }),
        ('Contact Details', {
